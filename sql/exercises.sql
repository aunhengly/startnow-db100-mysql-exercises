...
# The same  WHERE not active OR last_name LIKE '%M'
...
SELECT staff_id, first_name, last_name, address_id, picture, email,last_update, store_id, active, username
FROM staff
...
FROM payment
WHERE date(payment_date) IN ('20050525', '20050527', '20050529');
...
SELECT * 
FROM payment
WHERE date(payment_date) BETWEEN '20050525000000' AND '20050525235959';
...
SELECT
    ...
    address.postal_code,
    city.city
FROM staff LEFT JOIN (address, city)
